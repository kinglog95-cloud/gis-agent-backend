...
def proximity_exposure_analysis(lat, lon, radius_m, point_category,
    ...
    # 1. Fetch both layers
    point_feats = query_osm(lat, lon, radius_m, point_category)
...
def health():
    return jsonify({'status': 'ok', 'message': 'GIS Agent Backend running ✅ (V3.5a — geoprocessing + geocoding hardening)'})
